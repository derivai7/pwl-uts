                ...
                <div class="card-header">
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('nama') is-invalid @enderror"
                               value="{{ old('nama') }}" id="nama" name="nama" type="text"/>
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('spesialis') is-invalid @enderror"
                               value="{{ old('spesialis') }}" id="spesialis" name="spesialis" type="text"/>
                        @error('spesialis')
                        <small class="text-danger">{{ $message }} </small>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('pengalaman') is-invalid @enderror"
                               value="{{ old('pengalaman') }}" id="pengalaman" name="pengalaman" type="text"/>
                        @error('pengalaman')
                        <small class="text-danger">{{ $message }} </small>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('alamat') is-invalid @enderror"
                               value="{{ old('alamat') }}" id="alamat" name="alamat" type="text"/>
                        @error('alamat')
                        <small class="text-danger">{{ $message }} </small>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('nomor_telepon') is-invalid @enderror"
                               value="{{ old('nomor_telepon') }}" id="nomor_telepon" name="nomor_telepon"
                               type="text"/>
                        @error('nomor_telepon')
                        <small class="text-danger">{{ $message }} </small>
                        @enderror
